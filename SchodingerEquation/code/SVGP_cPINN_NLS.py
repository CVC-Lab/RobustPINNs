...
Original file is located at
    https://colab.research.google.com/drive/1pjOJpZRRz8_2o4xejyKxbiUHdTFjdoeV
"""
...
class cPINN:
    ...
    def build_model(self, boundaries, Layers, N0, Nb, Nf, Nt):
        ...
        for ii in range(len(boundaries) - 1):
            ...
            list_PINNs.append(PINN(LBs, UBs, Layers, N0, Nb, Nf, Nt, self.InError, self.Activation, self.model_name, self.device, self.do_smoothing, self.N0pool, self.threshold, self.display_freq))
        return list_PINNs
